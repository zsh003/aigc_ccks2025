...
OUTPUT_DIR = "0719/fine_tuned_model_0.6B_lora-fv_v8"
RESULT_PATH = "0719/submit_0.6B_lora-fv_v8.txt"
CHECKPOINT_DIR = "0719/checkpoints_0.6B_lora-fv_v8"
MULTI_RESULT_DIR = "0719/outputs"
...
def main():
    ...
    val_df = val_df.iloc[:50]  # 只用前50条验证，防止评估OOM
    print(f"训练集: {len(train_df)} 条，验证集: {len(val_df)} 条 (仅前50条)")
