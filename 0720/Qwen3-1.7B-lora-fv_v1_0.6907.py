...
# 定义路径
MODEL_NAME = "0720/fine_tuned_model"
TRAIN_PATH = "../datasets/train/train.jsonl"
TEST_PATH = "../datasets/test_717/test.jsonl"
OUTPUT_DIR = "0720/fine_tuned_model"
RESULT_PATH = "0720/submit.txt"
CHECKPOINT_DIR = "0720/checkpoints"
...
def main():
    ...
    # 设置训练参数（适合4090+24G显卡的机器）
    training_args = TrainingArguments(
        output_dir=CHECKPOINT_DIR,
        num_train_epochs=1,
        per_device_train_batch_size=4,  # 减少batch_size避免显存不足
        per_device_eval_batch_size=4,
        gradient_accumulation_steps=2,  # 增加梯度累积步数
        learning_rate=2e-5,
        weight_decay=0.01,
        max_grad_norm=1.0,  # 添加梯度裁剪
        warmup_steps=100,    # 引入学习率预热
        save_strategy="steps",
        ...
        dataloader_num_workers=4,    # 禁用多进程数据加载
